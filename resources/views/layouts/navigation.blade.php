    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center">
                <a href="{{ route('customer.home') }}" class="text-3xl font-bold text-gray-800">
                    Yakizen
                </a>
            </div>

            <!-- Navigation Links kanan -->
            <div class="hidden sm:flex sm:items-center sm:space-x-8 ml-auto text-lg">
